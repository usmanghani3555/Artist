...
class ClientTest extends TestCase
{
    public function testDoRequest()
    {
        ...
        $client->request('GET', 'http://www.example.com/?parameter=https://google.com');
        $this->assertEquals('http://www.example.com/?parameter='.urlencode('https://google.com'), $client->getRequest()->getUri(), '->doRequest() uses the request handler to make the request');
    }
