    ...
    <div class="m-content">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="{{route('submitedcoupon')}}" class="btn btn-circle btn-success"><i class="fa fa fa-gift"></i> Submited Coupon</a>
            </div>
        </div>
        <br />
                            ...
                            <td>
                                ...
                                <div id="divID{{$val->id}}" class="form-group m-form__group row collapse in">
                                    <div class="col-lg-12">
                                        ...
                                        <button id="submitCoupeId{{$val->id}}" name="submitCoupe" data-id="{{$val->id}}" data-update="" class="btn btn-success submitCoupe">Submit</button>
                                    </div>
                                </div>
                                <!-- <i href="{{route('edit_point', $val->id)}}" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Edit Coin Info" class="btn btn-outline-accent m-btn m-btn--icon btn-sm m-btn--icon-only m-btn--pill m-btn--air"><i class="fa flaticon-edit"></i></a> -->
