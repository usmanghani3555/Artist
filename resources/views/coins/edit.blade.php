...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" id="ediform" method="POST" action="{{route('coin.update', $coin->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control m-input" name="amount" id="amount" value="{{ $coin->amount }}" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Enter Amount" placeholder="Enter Amount">
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="file" class="form-control m-input" name="image" id="image" value="{{ old('image') }}" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="Gift Card Image Upload">
                            <br />
                            @if(!(empty($coin->image)) && file_exists( public_path().'/coin/'.$coin->image ))
                            
                            <img name="edit_blah" id="edit_blah" src="{{asset('public/coin/'.$coin->image)}}" alt="Gift Card Old Image" title="Gift Card Old Image" style="height:100px; widt:100px" />    
                            @endif
                            <img id="blah" src="#" alt="Gift Card New Image" title="Gift Card New Image" style="display:none; height:100px; width:100px" />
                        </div>
                    </div>
